...
local Ammo  = Types.Register("Plutonium","HEAT")
...
function Ammo:OnLoaded()
	...
	self.Name		 = "Plutonium"
	self.Description = "A shell filled with Plutonium, imploding on impact."
	self.Blacklist = {
		MG = true,
		RAC = true,
		SL = true,
...
if SERVER then
	...
	function Ammo:Network(Entity, BulletData)
		...
		Entity:SetNW2String("AmmoType", "Plutonium")
	end
	...
	ACF.RegisterAmmoDecal("Plutonium", "damage/he_pen", "damage/he_rico")
