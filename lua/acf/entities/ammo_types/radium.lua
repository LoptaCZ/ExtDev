...
local Ammo  = Types.Register("Radium","HEAT")
...
function Ammo:OnLoaded()
	...
	self.Name		 = "Radium"
	self.Description = "A shell filled with Radium, imploding on impact."
	self.Blacklist = {
		MG = true,
		RAC = true,
		SL = true,
...
if SERVER then
	...
	function Ammo:Network(Entity, BulletData)
		...
		Entity:SetNW2String("AmmoType", "Radium")
	end
	...
	ACF.RegisterAmmoDecal("Radium", "damage/he_pen", "damage/he_rico")
