...
local Ammo  = Types.Register("U-235","HEAT")


function Ammo:OnLoaded()
	Ammo.BaseClass.OnLoaded(self)

	self.Name		 = "Uranium 235"
	self.Description = "A shell filled with uranium-235, imploding on impact."
	self.Blacklist = {
		MG = true,
		RAC = true,
		SL = true,
...
if SERVER then
	...
	function Ammo:Network(Entity, BulletData)
		...
		Entity:SetNW2String("AmmoType", "U-235")
	end
	...
	ACF.RegisterAmmoDecal("U-235", "damage/he_pen", "damage/he_rico")
