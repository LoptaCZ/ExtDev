...
local Ammo  = Types.Register("U-238","HEAT")


function Ammo:OnLoaded()
	Ammo.BaseClass.OnLoaded(self)

	self.Name		 = "Uranium 238"
	self.Description = "A shell filled with uranium-238, imploding on impact."
	self.Blacklist = {
		MG = true,
		RAC = true,
		SL = true,
...
if SERVER then
	...
	function Ammo:Network(Entity, BulletData)
		...
		Entity:SetNW2String("AmmoType", "U-238")
	end
	...
	ACF.RegisterAmmoDecal("U-238", "damage/he_pen", "damage/he_rico")
