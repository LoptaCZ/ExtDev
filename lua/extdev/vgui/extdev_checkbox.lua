...
derma.DefineControl( "extdev_checkbox", "Simple Checkbox", PANEL, "DButton" )
...
function PANEL:Init()
	...
	self.Button = vgui.Create( "extdev_checkbox", self )
	self.Button.OnChange = function( _, val ) self:OnChange( val ) end

	self.Label = vgui.Create( "extdev_label", self )
...
derma.DefineControl( "extdev_checkbox_label", "Simple Checkbox", PANEL, "DPanel" )
