...
SWEP.ViewModel = Model("models/weapons/v_xm25.mdl")
SWEP.WorldModel = Model("models/weapons/w_xm25.mdl")
...
SWEP.Primary.Sound = "acf_base/weapons/mg_fire"
...
function SWEP:PrimaryAttack()
	...
	self.Weapon:EmitSound(Sound(self.Primary.Sound..math.random(1,4)..".mp3"))
